...
nop = i0 NOP
aconst_null :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
aconst_null = i0 $ ACONST_NULL
iconst_m1 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
iconst_m1 = i0 ICONST_M1
iconst_0 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
iconst_0 = i0 $ CONST_0 ILFD_I
iconst_1 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
iconst_1 = i0 $ CONST_1 ILFD_I
iconst_2 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
iconst_2 = i0 $ CONST_2 T32_I
iconst_3 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
iconst_3 = i0 ICONST_3
iconst_4 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
iconst_4 = i0 ICONST_4
iconst_5 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
iconst_5 = i0 ICONST_5
lconst_0 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
lconst_0 = i0 $ CONST_0 ILFD_L
lconst_1 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
lconst_1 = i0 $ CONST_1 ILFD_L
fconst_0 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
fconst_0 = i0 $ CONST_0 ILFD_F
fconst_1 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
fconst_1 = i0 $ CONST_1 ILFD_F
fconst_2 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
fconst_2 = i0 $ CONST_2 T32_F
dconst_0 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
dconst_0 = i0 $ CONST_0 ILFD_D
dconst_1 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
dconst_1 = i0 $ CONST_1 ILFD_D

bipush :: forall m. MonadThrow GenError m => MonadState GState m => Word8 -> m Unit
bipush x = i0 (BIPUSH x)
sipush :: forall m. MonadThrow GenError m => MonadState GState m => Word16 -> m Unit
...
iload_ :: forall m. MonadThrow GenError m => MonadState GState m => IMM -> m Unit
iload_ x = i0 (LOAD_ ILFDA_I x)
lload_ :: forall m. MonadThrow GenError m => MonadState GState m => IMM -> m Unit
lload_ x = i0 (LOAD_ ILFDA_L x)
fload_ :: forall m. MonadThrow GenError m => MonadState GState m => IMM -> m Unit
...
laload :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
laload = i0 $ ALOAD JTA_I
faload :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
faload = i0 $ ALOAD JTA_F
daload :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
daload = i0 $ ALOAD JTA_D
aaload :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
aaload = i0 $ ALOAD JTA_A
caload :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
caload = i0 $ ALOAD JTA_C
saload :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
...
istore_ :: forall m. MonadThrow GenError m => MonadState GState m => IMM -> m Unit
istore_ x = i0 (STORE_ ILFDA_I x)
lstore_ :: forall m. MonadThrow GenError m => MonadState GState m => IMM -> m Unit
lstore_ x = i0 (STORE_ ILFDA_L x)
fstore_ :: forall m. MonadThrow GenError m => MonadState GState m => IMM -> m Unit
fstore_ x = i0 (STORE_ ILFDA_F x)
dstore_ :: forall m. MonadThrow GenError m => MonadState GState m => IMM -> m Unit
dstore_ x = i0 (STORE_ ILFDA_D x)
astore_ :: forall m. MonadThrow GenError m => MonadState GState m => IMM -> m Unit
astore_ x = i0 (STORE_ ILFDA_I x)

iastore :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
iastore = i0 $ ASTORE JTA_I
lastore :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
lastore = i0 $ ASTORE JTA_I
fastore :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
fastore = i0 $ ASTORE JTA_F
dastore :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
dastore = i0 $ ASTORE JTA_D
aastore :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
aastore = i0 $ ASTORE JTA_A
castore :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
castore = i0 $ ASTORE JTA_C
sastore :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
sastore = i0 $ ASTORE JTA_S

pop :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
pop     = i0 $ STACK_OP Pop
pop2 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
pop2    = i0 $ STACK_OP Pop2
dup :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
dup     = i0 $ STACK_OP Dup
dup_x1 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
dup_x1  = i0 $ STACK_OP Dup_x1
dup_x2 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
dup_x2  = i0 $ STACK_OP Dup_x2
dup2 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
dup2    = i0 $ STACK_OP Dup2
dup2_x1 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
dup2_x1 = i0 $ STACK_OP Dup2_x1
dup2_x2 :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
dup2_x2 = i0 $ STACK_OP Dup2_x2
swap :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
swap    = i0 $ STACK_OP Swap

iadd :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
iadd    = i0 $ NUM_OP Add ILFD_I
ladd :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
ladd    = i0 $ NUM_OP Add ILFD_L
fadd :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
fadd    = i0 $ NUM_OP Add ILFD_F
dadd :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
dadd    = i0 $ NUM_OP Add ILFD_D
isub :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
isub    = i0 $ NUM_OP Sub ILFD_I
lsub :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
lsub    = i0 $ NUM_OP Sub ILFD_L
fsub :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
fsub    = i0 $ NUM_OP Sub ILFD_F
dsub :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
dsub    = i0 $ NUM_OP Sub ILFD_D
imul :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
imul    = i0 $ NUM_OP Mul ILFD_I
lmul :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
lmul    = i0 $ NUM_OP Mul ILFD_L
fmul :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
fmul    = i0 $ NUM_OP Mul ILFD_F
dmul :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
dmul    = i0 $ NUM_OP Mul ILFD_D
idiv :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
idiv    = i0 $ NUM_OP Div ILFD_I
ldiv :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
ldiv    = i0 $ NUM_OP Div ILFD_L
fdiv :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
fdiv    = i0 $ NUM_OP Div ILFD_F
ddiv :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
ddiv    = i0 $ NUM_OP Div ILFD_D
irem :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
irem    = i0 $ NUM_OP Rem ILFD_I
lrem :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
lrem    = i0 $ NUM_OP Rem ILFD_L
frem :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
frem    = i0 $ NUM_OP Rem ILFD_F
drem :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
drem    = i0 $ NUM_OP Rem ILFD_D
ineg :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
ineg    = i0 $ NUM_OP Neg ILFD_I
lneg :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
lneg    = i0 $ NUM_OP Neg ILFD_L
fneg :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
fneg    = i0 $ NUM_OP Neg ILFD_F
dneg :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
dneg    = i0 $ NUM_OP Neg ILFD_D

ishl :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
ishl    = i0 $ BIT_OP Shl IL_I
lshl :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
lshl    = i0 $ BIT_OP Shl IL_L
ishr :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
ishr    = i0 $ BIT_OP Shr IL_I
lshr :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
lshr    = i0 $ BIT_OP Shr IL_L
iushr :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
iushr   = i0 $ BIT_OP Ushr IL_I
lushr :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
lushr   = i0 $ BIT_OP Ushr IL_L
iand :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
iand    = i0 $ BIT_OP And IL_I
land :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
land    = i0 $ BIT_OP And IL_L
ior :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
ior     = i0 $ BIT_OP Or IL_I
lor :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
lor     = i0 $ BIT_OP Or IL_L
ixor :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
ixor    = i0 $ BIT_OP Xor IL_I
lxor :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
lxor    = i0 $ BIT_OP Xor IL_L

iinc :: forall m. MonadThrow GenError m => MonadState GState m => Word8 -> Word8 -> m Unit
iinc x y = i0 $ IINC x y

i2l :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
i2l  = i0 $ CONVERT ILFD_I JT_L
i2f :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
i2f  = i0 $ CONVERT ILFD_I JT_F
i2d :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
i2d  = i0 $ CONVERT ILFD_I JT_D
l2i :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
l2i  = i0 $ CONVERT ILFD_L JT_I
l2f :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
l2f  = i0 $ CONVERT ILFD_L JT_F
l2d :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
l2d  = i0 $ CONVERT ILFD_L JT_D
f2i :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
f2i  = i0 $ CONVERT ILFD_F JT_I
f2l :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
f2l  = i0 $ CONVERT ILFD_F JT_L
f2d :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
f2d  = i0 $ CONVERT ILFD_F JT_D
d2i :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
d2i  = i0 $ CONVERT ILFD_D JT_I
d2l :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
d2l  = i0 $ CONVERT ILFD_D JT_L
d2f :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
d2f  = i0 $ CONVERT ILFD_D JT_F
i2b :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
i2b  = i0 $ CONVERT ILFD_I JT_B
i2c :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
i2c  = i0 $ CONVERT ILFD_I JT_C
i2s :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
i2s  = i0 $ CONVERT ILFD_I JT_S

lcmp :: forall m. MonadThrow GenError m => MonadState GState m => m Unit
lcmp = i0 LCMP
fcmp :: forall m. MonadThrow GenError m => MonadState GState m => CMP -> m Unit
...
newArray :: forall m. MonadThrow GenError m => MonadState GState m => ArrayType -> m Unit
newArray t =
